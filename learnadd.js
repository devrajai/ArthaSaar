...
(function () {
  ...
  var gd = glCard("newToolsGuide", "Naye Tools - kaise use karein",
    '<div class="note" style="margin-top:8px">📖 <b>ArthaSaar Learning Hub</b> — written in simple English for Dev. Educational only, not investment advice. Read in order: Beginner first, then Intermediate, then Advanced.<br>Educational analysis only — not SEBI-registered investment advice.</div>' +

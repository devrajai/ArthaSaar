...
(function () {
  ...
  function build(card) {
    var guide = '<details style="margin-top:8px"><summary style="cursor:pointer;padding:8px 12px;border-radius:9px;background:rgba(255,255,255,.05);border:1px solid rgba(255,255,255,.1);font-size:13px"><b>\u2753 SPIKE GUIDE</b> <span style="font-size:11px;opacity:.6">kaise padhein \u00b7 buy/sell/hold</span></summary>' +
      ...
      '<div style="margin-top:8px"><b style="color:rgba(240,180,41,.9)">Timeframe:</b> spike ka asar mostly 1-3 din (BTST/swing). Positional/long-term ke liye sentiment kam, <b>ArthaSaar Score</b> (Screener) zyada matter karta hai. Intraday ke liye news akela kaafi nahi - price action + volume + OI chahiye.</div>' +

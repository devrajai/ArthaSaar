#!/usr/bin/env python3
"""fix_gti3.py - GTI Complete Guide card (gtiinfo.js) Learn + GTI section mein,
app.js loader mein add, index.html version bump."""

GTIINFO = r'''/* gtiinfo.js - GTI Complete Guide: sab GTI info ek jagah (Learn + GTI section) */
(function () {
...
def main():
    # 1. gtiinfo.js likho
    with open("gtiinfo.js", "w", encoding="utf-8") as f:
        f.write(GTIINFO)
    # 2. app.js loader mein add karo
    app = open("app.js", encoding="utf-8").read()
    if "gtiinfo.js" not in app:
        assert '"manish.js"' in app, "app.js anchor missing"
        app = app.replace('"manish.js"', '"manish.js", "gtiinfo.js"')
        open("app.js", "w", encoding="utf-8").write(app)
        print("app.js: gtiinfo.js added to loader")
    else:
        print("app.js: already present")
    # 3. index.html version bump
    idx = open("index.html", encoding="utf-8").read()
    old = "app.js?v=21sep26w"
    if old in idx:
        idx = idx.replace(old, "app.js?v=21sep26x")
        open("index.html", "w", encoding="utf-8").write(idx)
        print("index.html: bumped to 21sep26x")
    elif "21sep26x" in idx:

#!/usr/bin/env python3
"""morning_brief.py - 7:00 IST daily: mood + crash + top bull + rotation + aaj ke events/results."""
import sys, datetime
...
if rot:
    L.append("\U0001F504 Rotation: " + " - ".join("%s %+.1f%%" % (r.get("name"), r.get("chg30") or 0) for r in rot))
